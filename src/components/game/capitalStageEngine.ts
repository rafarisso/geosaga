...
export const PLAYABLE_CAPITAL_IDS: CapitalId[] = ['sao-paulo', 'rio-de-janeiro', 'belo-horizonte', 'vitoria', 'curitiba', 'florianopolis', 'porto-alegre', 'brasilia', 'goiania', 'cuiaba', 'campo-grande', 'salvador', 'recife', 'fortaleza', 'natal', 'joao-pessoa', 'maceio', 'aracaju', 'teresina', 'sao-luis', 'belem', 'manaus', 'boa-vista', 'macapa', 'porto-velho', 'rio-branco', 'palmas'];
...
export const CAPITAL_STAGE_DEFINITIONS: Partial<Record<CapitalId, CapitalStageDefinition>> = {
  ...
  belem: {
    ...
    route: 'norte',
    city: 'Belem',
    introTitle: 'Belem: Mare do Mercado',
    introObjective:
      'Atravesse o estuario, proteja o Ver-o-Peso, leia a chuva equatorial e use conhecimento para derrotar a Mare do Mercado.',
    finishLabel: 'Restaurar o estuario amazonico',
    gateHint: 'Colete os 3 marcos e derrote mare cruzada, barco lotado, chuva repentina e canal contaminado para liberar o chefe.',
    victoryTitle: 'Belem concluida',
    victoryBody:
      'Voce conectou Ver-o-Peso, Baia do Guajara, ilhas, rios, chuva equatorial, mobilidade fluvial e saneamento em uma leitura geografica de Belem.',
    boss: {
      name: 'Mare do Mercado',
      hp: 462,
      damage: 18,
      attackTimer: 1.06,
      spawnText: 'A Mare do Mercado subiu com a forca do estuario!',
      pressureText: 'Chuva, canais e correnteza em pressao maxima!',
      victoryText: 'Belem restaurada!',
    },
    enemies: [
      {
        id: 'pa-mare-cruzada',
      ...
      },
      {
        ...
        kind: 'soundcar',
        name: 'Barco Lotado',
        concept: 'Transporte fluvial',
        baseX: 1180,
        feetY: CAPITAL_GROUND_Y - 10,
        hp: 124,
        damage: 14,
        phase: 1.42,
        attackTimer: 1.14,
      ...
      {
        id: 'pa-chuva-repentina',
        kind: 'flood',
        name: 'Chuva Repentina',
        concept: 'Clima equatorial',
        baseX: 1720,
        feetY: CAPITAL_GROUND_Y - 72,
        hp: 108,
        damage: 13,
      ...
      {
        id: 'pa-canal-contaminado',
        kind: 'smog',
        name: 'Canal Contaminado',
        concept: 'Saneamento urbano',
        baseX: 2280,
        feetY: CAPITAL_GROUND_Y - 24,
        hp: 130,
        damage: 15,
        phase: 3.1,
        attackTimer: 1.22,
    ...
    objectives: [
      { id: 'ver-o-peso', label: 'Ver-o-Peso', concept: 'Mercado e cidade ribeirinha', x: 430, y: 338 },
      { id: 'baia-guajara', label: 'Baia do Guajara', concept: 'Estuario amazonico', x: 1460, y: 336 },
      { id: 'ilhas-rios-belem', label: 'Ilhas e rios', concept: 'Rede insular e fluvial', x: 2420, y: 330 },
    ],
  },
  manaus: {
    capital: 'manaus',
    route: 'norte',
    city: 'Manaus',
    introTitle: 'Manaus: Aguas Escuras',
    introObjective:
      'Atravesse a metropole amazonica, leia o encontro das aguas, cuide dos igarapes e use conhecimento para derrotar o Guardiao das Aguas Escuras.',
    finishLabel: 'Restaurar o Rio Negro urbano',
    gateHint: 'Colete os 3 marcos e derrote encontro turvo, porto enferrujado, calor umido e igarape sufocado para liberar o chefe.',
    victoryTitle: 'Manaus concluida',
    victoryBody:
      'Voce conectou Teatro Amazonas, Porto de Manaus, Rio Negro, Encontro das Aguas, igarapes, calor umido e logistica fluvial em uma leitura geografica da capital amazonense.',
    boss: {
      name: 'Guardiao das Aguas Escuras',
      hp: 478,
      damage: 19,
      attackTimer: 1.04,
      spawnText: 'O Guardiao das Aguas Escuras emergiu do Rio Negro!',
      pressureText: 'Correntes, porto e igarapes pressionam Manaus!',
      victoryText: 'Manaus restaurada!',
    },
    enemies: [
      {
        id: 'am-encontro-turvo',
        kind: 'tide',
        name: 'Encontro Turvo',
        concept: 'Encontro das Aguas',
        baseX: 620,
        feetY: CAPITAL_GROUND_Y,
        hp: 118,
        damage: 14,
      ...
      {
        id: 'am-porto-enferrujado',
        kind: 'traffic',
        name: 'Porto Enferrujado',
        concept: 'Logistica fluvial',
        baseX: 1180,
        feetY: CAPITAL_GROUND_Y - 8,
        hp: 128,
        damage: 15,
        phase: 1.55,
        attackTimer: 1.16,
      ...
      {
        id: 'am-igarape-sufocado',
        kind: 'smog',
        name: 'Igarape Sufocado',
        concept: 'Saneamento e rios urbanos',
        baseX: 2280,
        feetY: CAPITAL_GROUND_Y - 28,
        hp: 132,
        damage: 15,
    ...
    objectives: [
      { id: 'teatro-amazonas', label: 'Teatro Amazonas', concept: 'Centro historico', x: 430, y: 338 },
      { id: 'porto-manaus', label: 'Porto de Manaus', concept: 'Cidade fluvial', x: 1460, y: 336 },
      { id: 'encontro-aguas', label: 'Encontro das Aguas', concept: 'Rio Negro e Solimoes', x: 2420, y: 330 },
    ],
  },
  'boa-vista': {
    capital: 'boa-vista',
    route: 'norte',
    city: 'Boa Vista',
    introTitle: 'Boa Vista: Sentinela do Lavrado',
    introObjective:
      'Cruze a cidade radial, leia o Rio Branco, atravesse o lavrado e use conhecimento para derrotar a Sentinela do Lavrado.',
    finishLabel: 'Restaurar o lavrado urbano',
    gateHint: 'Colete os 3 marcos e derrote avenida radial, Rio Branco secante, poeira do lavrado e fronteira nebulosa para liberar o chefe.',
    victoryTitle: 'Boa Vista concluida',
    victoryBody:
      'Voce conectou planejamento urbano radial, Rio Branco, lavrado, extremo norte, fronteira e savana amazonica em uma leitura geografica de Boa Vista.',
    boss: {
      name: 'Sentinela do Lavrado',
      hp: 470,
      damage: 18,
      attackTimer: 1.08,
      spawnText: 'A Sentinela do Lavrado levantou poeira no extremo norte!',
      pressureText: 'Avenidas, rio e lavrado em tensao maxima!',
      victoryText: 'Boa Vista restaurada!',
    },
    enemies: [
      {
        id: 'rr-avenida-radial',
        kind: 'traffic',
        name: 'Avenida Radial',
        concept: 'Planejamento urbano',
        baseX: 620,
        feetY: CAPITAL_GROUND_Y - 8,
        hp: 116,
        damage: 14,
      ...
      {
        id: 'rr-rio-branco-secante',
        kind: 'tide',
        name: 'Rio Branco Secante',
        concept: 'Regime fluvial',
        baseX: 1180,
        feetY: CAPITAL_GROUND_Y,
        hp: 122,
        damage: 14,
      ...
      {
        id: 'rr-poeira-lavrado',
        kind: 'heat',
        name: 'Poeira do Lavrado',
        concept: 'Savana amazonica',
        baseX: 1720,
        feetY: CAPITAL_GROUND_Y - 38,
        hp: 112,
        damage: 13,
        phase: 2.24,
        attackTimer: 0.96,
      ...
      {
        id: 'rr-fronteira-nebulosa',
        kind: 'smog',
        name: 'Fronteira Nebulosa',
        concept: 'Extremo norte',
        baseX: 2280,
        feetY: CAPITAL_GROUND_Y - 34,
        hp: 128,
        damage: 15,
        phase: 3.08,
        attackTimer: 1.18,
    ...
    objectives: [
      { id: 'rio-branco-rr', label: 'Rio Branco', concept: 'Eixo fluvial', x: 430, y: 338 },
      { id: 'avenidas-radiais', label: 'Avenidas radiais', concept: 'Plano urbano', x: 1460, y: 336 },
      { id: 'lavrado-roraima', label: 'Lavrado', concept: 'Savana amazonica', x: 2420, y: 330 },
    ],
  },
  macapa: {
    capital: 'macapa',
    route: 'norte',
    city: 'Macapa',
    introTitle: 'Macapa: Colosso da Linha',
    introObjective:
      'Atravesse a beira do Amazonas, proteja a fortaleza, leia a Linha do Equador e use conhecimento para derrotar o Colosso da Linha.',
    finishLabel: 'Restaurar a cidade equatorial',
    gateHint: 'Colete os 3 marcos e derrote Linha do Equador, muralha encharcada, ressaca amazonica e lama de varzea para liberar o chefe.',
    victoryTitle: 'Macapa concluida',
    victoryBody:
      'Voce conectou Linha do Equador, Fortaleza de Sao Jose, Rio Amazonas, varzea, ressaca fluvial e cidade equatorial em uma leitura geografica de Macapa.',
    boss: {
      name: 'Colosso da Linha',
      hp: 472,
      damage: 18,
      attackTimer: 1.06,
      spawnText: 'O Colosso da Linha dividiu a fase no meio do mundo!',
      pressureText: 'Equador, Amazonas e varzea em pressao maxima!',
      victoryText: 'Macapa restaurada!',
    },
    enemies: [
      {
        id: 'ap-linha-equador',
      ...
      {
        id: 'ap-muralha-encharcada',
        kind: 'traffic',
        name: 'Muralha Encharcada',
        concept: 'Fortaleza historica',
        baseX: 1180,
        feetY: CAPITAL_GROUND_Y - 10,
        hp: 126,
        damage: 15,
      ...
      {
        id: 'ap-ressaca-amazonica',
        kind: 'tide',
        name: 'Ressaca Amazonica',
        concept: 'Dinamica fluvial',
        baseX: 1720,
        feetY: CAPITAL_GROUND_Y,
        hp: 122,
        damage: 14,
      ...
      },
      {
        ...
        kind: 'flood',
        name: 'Lama de Varzea',
        concept: 'Planicie inundavel',
        baseX: 2280,
        feetY: CAPITAL_GROUND_Y - 18,
        hp: 128,
        damage: 15,
        phase: 3.12,
        attackTimer: 1.2,
    ...
    objectives: [
      { id: 'linha-equador', label: 'Linha do Equador', concept: 'Latitude zero', x: 430, y: 338 },
      { id: 'fortaleza-sao-jose', label: 'Fortaleza de Sao Jose', concept: 'Patrimonio e defesa', x: 1460, y: 336 },
      { id: 'rio-amazonas-macapa', label: 'Rio Amazonas', concept: 'Fronteira fluvial', x: 2420, y: 330 },
    ],
  },
  'porto-velho': {
    capital: 'porto-velho',
    route: 'norte',
    city: 'Porto Velho',
    introTitle: 'Porto Velho: Locomotiva do Madeira',
    introObjective:
      'Atravesse os trilhos historicos, leia o Rio Madeira, enfrente a logistica fluvial e use conhecimento para derrotar a Locomotiva do Madeira.',
    finishLabel: 'Restaurar a rota do Madeira',
    gateHint: 'Colete os 3 marcos e derrote trilho torcido, corrente do Madeira, guindaste fantasma e fumaca da logistica para liberar o chefe.',
    victoryTitle: 'Porto Velho concluida',
    victoryBody:
      'Voce conectou Rio Madeira, Estrada de Ferro Madeira-Mamore, porto, logistica, floresta e crescimento urbano em uma leitura geografica de Porto Velho.',
    boss: {
      name: 'Locomotiva do Madeira',
      hp: 486,
      damage: 19,
      attackTimer: 1.02,
      spawnText: 'A Locomotiva do Madeira voltou dos trilhos enferrujados!',
      pressureText: 'Rio, ferrovia e porto em pressao maxima!',
      victoryText: 'Porto Velho restaurada!',
    },
    enemies: [
      {
        id: 'ro-trilho-torcido',
        kind: 'traffic',
        name: 'Trilho Torcido',
        concept: 'Ferrovia historica',
        baseX: 620,
        feetY: CAPITAL_GROUND_Y - 8,
        hp: 122,
        damage: 14,
      ...
      {
        id: 'ro-corrente-madeira',
        kind: 'tide',
        name: 'Corrente do Madeira',
        concept: 'Hidrografia',
        baseX: 1180,
        feetY: CAPITAL_GROUND_Y,
        hp: 124,
      ...
      {
        id: 'ro-guindaste-fantasma',
        kind: 'soundcar',
        name: 'Guindaste Fantasma',
        concept: 'Logistica fluvial',
        baseX: 1720,
        feetY: CAPITAL_GROUND_Y - 12,
        hp: 130,
        damage: 15,
        phase: 2.32,
        attackTimer: 1.14,
      ...
      {
        id: 'ro-fumaca-logistica',
        kind: 'smog',
        name: 'Fumaca da Logistica',
        concept: 'Transporte e ar urbano',
        baseX: 2280,
        feetY: CAPITAL_GROUND_Y - 34,
        hp: 128,
        damage: 15,
    ...
    objectives: [
      { id: 'rio-madeira', label: 'Rio Madeira', concept: 'Eixo fluvial', x: 430, y: 338 },
      { id: 'ferrovia-madeira-mamore', label: 'Madeira-Mamore', concept: 'Ferrovia historica', x: 1460, y: 336 },
      { id: 'porto-madeira', label: 'Porto fluvial', concept: 'Logistica amazonica', x: 2420, y: 330 },
    ],
  },
  'rio-branco': {
    capital: 'rio-branco',
    route: 'norte',
    city: 'Rio Branco',
    introTitle: 'Rio Branco: Seringal Sombrio',
    introObjective:
      'Atravesse a Gameleira, leia o Rio Acre, enfrente a memoria da borracha e use conhecimento para derrotar o Seringal Sombrio.',
    finishLabel: 'Restaurar a margem do Rio Acre',
    gateHint: 'Colete os 3 marcos e derrote Rio Acre barrento, seringueira viva, passarela fantasma e chuva da fronteira para liberar o chefe.',
    victoryTitle: 'Rio Branco concluida',
    victoryBody:
      'Voce conectou Rio Acre, Gameleira, floresta, borracha, fronteira oeste e crescimento urbano em uma leitura geografica da capital acreana.',
    boss: {
      name: 'Seringal Sombrio',
      hp: 476,
      damage: 18,
      attackTimer: 1.06,
      spawnText: 'O Seringal Sombrio fechou a margem do Rio Acre!',
      pressureText: 'Rio, floresta e memoria da borracha em pressao maxima!',
      victoryText: 'Rio Branco restaurada!',
    },
    enemies: [
      {
        id: 'ac-rio-acre-barrento',
        kind: 'tide',
        name: 'Rio Acre Barrento',
        concept: 'Hidrografia urbana',
        baseX: 620,
        feetY: CAPITAL_GROUND_Y,
        hp: 122,
      ...
      {
        id: 'ac-seringueira-viva',
        kind: 'slope',
        name: 'Seringueira Viva',
        concept: 'Historia da borracha',
        baseX: 1180,
        feetY: CAPITAL_GROUND_Y - 12,
        hp: 124,
        damage: 14,
      ...
      {
        id: 'ac-passarela-fantasma',
        kind: 'traffic',
        name: 'Passarela Fantasma',
        concept: 'Travessia urbana',
        baseX: 1720,
        feetY: CAPITAL_GROUND_Y - 8,
        hp: 128,
        damage: 15,
      ...
      {
        id: 'ac-chuva-fronteira',
        kind: 'flood',
        name: 'Chuva da Fronteira',
        concept: 'Amazonia ocidental',
        baseX: 2280,
        feetY: CAPITAL_GROUND_Y - 52,
        hp: 126,
        damage: 15,
        phase: 3.1,
        attackTimer: 1.18,
    ...
    objectives: [
      { id: 'rio-acre', label: 'Rio Acre', concept: 'Eixo fluvial', x: 430, y: 338 },
      { id: 'gameleira', label: 'Gameleira', concept: 'Centro historico', x: 1460, y: 336 },
      { id: 'seringal-acre', label: 'Seringal', concept: 'Ciclo da borracha', x: 2420, y: 330 },
    ],
  },
  palmas: {
    capital: 'palmas',
    route: 'norte',
    city: 'Palmas',
    introTitle: 'Palmas: Sol do Tocantins',
    introObjective:
      'Atravesse a capital planejada, leia o Lago de Palmas, enfrente o calor do Cerrado e use conhecimento para derrotar o Sol do Tocantins.',
    finishLabel: 'Restaurar o lago do Tocantins',
    gateHint: 'Colete os 3 marcos e derrote calor do Cerrado, lago inquieto, avenida planejada e vento da serra para liberar o chefe.',
    victoryTitle: 'Palmas concluida',
    victoryBody:
      'Voce conectou Lago de Palmas, Rio Tocantins, capital planejada, cerrado, Serra do Lajeado e calor sazonal em uma leitura geografica de Palmas.',
    boss: {
      name: 'Sol do Tocantins',
      hp: 482,
      damage: 19,
      attackTimer: 1.04,
      spawnText: 'O Sol do Tocantins incendiou a margem do lago!',
      pressureText: 'Cerrado, lago e avenidas em pressao maxima!',
      victoryText: 'Palmas restaurada!',
    },
    enemies: [
      {
        id: 'to-calor-cerrado',
        kind: 'heat',
        name: 'Calor do Cerrado',
        concept: 'Clima tropical',
        baseX: 620,
        feetY: CAPITAL_GROUND_Y - 20,
        hp: 122,
        damage: 14,
        phase: 0.72,
        attackTimer: 0.98,
      ...
      {
        id: 'to-avenida-planejada',
        kind: 'traffic',
        name: 'Avenida Planejada',
        concept: 'Capital planejada',
        baseX: 1720,
        feetY: CAPITAL_GROUND_Y - 8,
        hp: 130,
        damage: 15,
      ...
      },
      {
        ...
        kind: 'smog',
        name: 'Vento da Serra',
        concept: 'Serra do Lajeado',
        baseX: 2280,
        feetY: CAPITAL_GROUND_Y - 36,
        hp: 126,
        damage: 15,
        phase: 3.08,
        attackTimer: 1.18,
    ...
    objectives: [
      { id: 'lago-palmas', label: 'Lago de Palmas', concept: 'Paisagem lacustre', x: 430, y: 338 },
      { id: 'ponte-fhc', label: 'Ponte FHC', concept: 'Conexao urbana', x: 1460, y: 336 },
      { id: 'serra-lajeado', label: 'Serra do Lajeado', concept: 'Relevo do cerrado', x: 2420, y: 330 },
    ],
  },
};
